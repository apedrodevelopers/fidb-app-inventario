...
<div class="content">
  ...
  <!--
      ...
      -->
  <form action="/admin/produtos/<?= $produto['id'] ?>/editar" method="POST" class="form-page">
    ...
    <div class="form-card">
      ...
      <div class="form-group">
        ...
        <input class="form-input" type="text" name="nome" placeholder="Ex: Teclado mecânico" value=" <?= $produto['nome'] ?> " />
        <!-- <p class="form-error">O nome é obrigatório.</p> -->
      </div>

      <div class="form-group">
        <label class="form-label">Descrição</label>
        <textarea class="form-textarea" name="descricao" placeholder="Descrição opcional do produto…"> <?= $produto['descricao'] ?> </textarea>
