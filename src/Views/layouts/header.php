...
<body class="page-app">
  ...
  <aside class="sidebar">
    ...
    <ul class="nav">
      <li><a href="/admin/dashboard" class="<?= $painel === 'dashboard' ? 'active' : '' ?>">
      ...
      <li><a href="/admin/produtos/lista" class="<?= $painel === 'produtos' ? 'active' : '' ?>">
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
      ...
      <li><a href="/admin/categorias/lista" class="<?= $painel === 'categorias' ? 'active' : '' ?>">
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            <path d="M2 4h11M2 7.5h7M2 11h5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" />
          </svg>
          Categorias
        </a></li>
      <li><a href="/admin/movimentos/lista" class="<?= $painel === 'movimentos' ? 'active' : '' ?>">
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
      ...
      <li><a href="/admin/utilizadores/lista" class="<?= $painel === 'utilizadores' ? 'active' : '' ?>">
          <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
